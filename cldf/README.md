...
# Wordlist CLDF dataset derived from Rankin et al.'s "Comparative Siouan Dictionary" from 2015

**CLDF Metadata**: [cldf-metadata.json](./cldf-metadata.json)

property | value
 --- | ---
[dc:bibliographicCitation](http://purl.org/dc/terms/bibliographicCitation) | Rankin, Robert L. & Carter, Richard T. & Jones, A. Wesley & Koontz, John E. & Rood, David S. & Hartmann, Iren (eds.) 2015. Comparative Siouan Dictionary. Leipzig: Max Planck Institute for Evolutionary Anthropology. (Available online at http://csd.clld.org)
[dc:conformsTo](http://purl.org/dc/terms/conformsTo) | [CLDF Wordlist](http://cldf.clld.org/v1.0/terms.rdf#Wordlist)
[dc:identifier](http://purl.org/dc/terms/identifier) | http://csd.clld.org
[dc:license](http://purl.org/dc/terms/license) | https://creativecommons.org/licenses/by/4.0/
[dcat:accessURL](http://www.w3.org/ns/dcat#accessURL) | https://github.com/lexibank/csd
[prov:wasDerivedFrom](http://www.w3.org/ns/prov#wasDerivedFrom) | <ol><li><a href="https://github.com/lexibank/csd/tree/5289293">lexibank/csd 5289293</a></li><li><a href="https://github.com/glottolog/glottolog/tree/b24dee3a41">Glottolog v5.1-12-gb24dee3a41</a></li><li><a href="https://github.com/concepticon/concepticon-data/tree/v3.3.0">Concepticon v3.3.0</a></li><li><a href="https://github.com/cldf-clts/clts/tree/v2.3.0">CLTS v2.3.0</a></li></ol>
...
[rdf:ID](http://www.w3.org/1999/02/22-rdf-syntax-ns#ID) | csd
...
[dc:extent](http://purl.org/dc/terms/extent) | 19086
...
[Source](http://cldf.clld.org/v1.0/terms.rdf#source) | list of `string` (separated by `;`) | Etymological (or comparative) dictionaries typically compare lexical data from many source dictionaries.
...
[dc:extent](http://purl.org/dc/terms/extent) | 8448
...
## <a name="table-cfcsv"></a>Table cf.csv
...
## <a name="table-cfitemscsv"></a>Table cfitems.csv
...
## <a name="table-borrowingscsv"></a>Table borrowings.csv
